...
class Tetris:
    ...
    def game_over(self):
        ...
        over = font.render(f'GAME OVER', True, RED)
        msg1 = font2.render(f'press "R" to restart', True, WHITE)
        msg2 = font2.render(f'press "ESC" to exit', True, WHITE)

        win.blit(over, (rect.centerx-over.get_width()//2, rect.y + 25))
        win.blit(msg1, (rect.centerx-msg1.get_width()//2, rect.y + 85))
        win.blit(msg2, (rect.centerx-msg2.get_width()//2, rect.y + 115))
# Main function
def main():
